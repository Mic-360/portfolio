var WDOSBOXX = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var ASM_CONSTS = {
      ...
      2000122: () => window.innerWidth,
      2000152: () => window.innerHeight,
      2000183: ($0, $1, $2) => {
        var w = $0
        var h = $1
        var pixels = $2
          ...
          case 'wc-net-connected':
            {
              if (Module.wsNetConnectResolve) {
                ...
                console.error(
                  'wc-net-connected recived but no awaiting promises, networkId:',
          ...
          case 'wc-sockdrive-opened':
            {
              ...
              for (let i = 0; i < data.props.emptyRangesCount; ++i) {
                ...
                Module.HEAPU8[offset] = value & 255
                Module.HEAPU8[offset + 1] = (value & 65280) >> 8
                Module.HEAPU8[offset + 2] = (value & 16711680) >> 16
                Module.HEAPU8[offset + 3] = (value & 4278190080) >> 24
              }
              Module['_em_client_sockdrive_opened'](
                data.props.handle,
                data.props.size,
                data.props.heads,
                data.props.cylinders,
                data.props.sectors,
                data.props.sectorSize,
                data.props.aheadRange,
                data.props.emptyRangesCount,
                ptr,
              )
              Module['_free'](ptr)
            }
          ...
          case 'wc-sockdrive-new-range':
            {
              ...
              Module['_em_client_sockdrive_new_range'](
                data.props.handle,
                data.props.range,
                ptr,
              )
    ...
    function em_server_sockdrive_open(handle, url) {
      Module.sendMessage('ws-sockdrive-open', {
        handle,
        url: UTF8ToString(url),
      })
    }
    function em_server_sockdrive_ready(handle) {
      Module.sendMessage('ws-sockdrive-ready', { handle })
    }
    function em_server_sockdrive_close(handle) {
      Module.sendMessage('ws-sockdrive-close', { handle })
    }
    function em_server_sockdrive_load_range(handle, range) {
      Module.sendMessage('ws-sockdrive-load-range', { handle, range })
    }
    function em_server_sockdrive_write_sector(handle, sector, buffer) {
    ...
    var JSEvents_requestFullscreen = (target, strategy) => {
      ...
      if (strategy.canvasResizedCallback) {
        ;((a1, a2, a3) =>
          dynCall_iiii(strategy.canvasResizedCallback, a1, a2, a3))(
          37,
          0,
    ...
    var wasmImports = {
      Rd: __asyncjs__em_net_connect,
      Jd: __asyncjs__em_unload,
      De: ___call_sighandler,
      Ce: ___syscall_chdir,
      Be: ___syscall_chmod,
      Ae: ___syscall_faccessat,
      c: ___syscall_fcntl64,
      ze: ___syscall_fstat64,
      ia: ___syscall_ftruncate64,
      ye: ___syscall_getcwd,
      xe: ___syscall_getdents64,
      s: ___syscall_ioctl,
      we: ___syscall_lstat64,
      ve: ___syscall_mkdirat,
      ue: ___syscall_newfstatat,
      r: ___syscall_openat,
      te: ___syscall_readlinkat,
      se: ___syscall_renameat,
      X: ___syscall_rmdir,
      re: ___syscall_stat64,
      qe: ___syscall_statfs64,
      q: ___syscall_unlinkat,
      le: __abort_js,
      ke: __emscripten_runtime_keepalive_clear,
      je: __emscripten_system,
      fa: __gmtime_js,
      ea: __localtime_js,
      da: __mktime_js,
      ie: __setitimer_js,
      ...
      fe: _eglBindAPI,
      ee: _eglChooseConfig,
      de: _eglCreateContext,
      ce: _eglCreateWindowSurface,
      be: _eglDestroyContext,
      ae: _eglDestroySurface,
      $d: _eglGetConfigAttrib,
      V: _eglGetDisplay,
      _d: _eglGetError,
      Zd: _eglInitialize,
      Yd: _eglMakeCurrent,
      ...
      Td: _eglWaitGL,
      Sd: _eglWaitNative,
      Qd: em_net_disconnect,
      Pd: em_net_send,
      Od: em_server_sockdrive_close,
      Nd: em_server_sockdrive_load_range,
      Md: em_server_sockdrive_open,
      Ld: em_server_sockdrive_ready,
      Kd: em_server_sockdrive_write_sector,
      Id: emsc_add_frame_line,
      Hd: emsc_end_frame_update,
      U: emsc_exit_runtime,
      Gd: emsc_extract_bundle_to_fs,
      T: emsc_getMTimeMs,
      Fd: emsc_init_backend,
      Ed: emsc_pack_fs_to_bundle,
      Dd: emsc_progress,
      Cd: emsc_start_frame_update,
      Bd: emsc_ws_client_frame_set_size,
      Ad: emsc_ws_client_sound_init,
      zd: emsc_ws_client_sound_push,
      yd: emsc_ws_exit_runtime,
      k: _emscripten_asm_const_int,
      b: _emscripten_asm_const_int_sync_on_main_thread,
      xd: _emscripten_asm_const_ptr_sync_on_main_thread,
      S: _emscripten_date_now,
      wd: _emscripten_exit_fullscreen,
      vd: _emscripten_exit_pointerlock,
      ud: _emscripten_exit_with_live_runtime,
      R: _emscripten_force_exit,
      ...
      $c: _emscripten_glClearColor,
      _c: _emscripten_glClearDepthf,
      Zc: _emscripten_glClearStencil,
      Yc: _emscripten_glClipControlEXT,
      Xc: _emscripten_glColorMask,
      Wc: _emscripten_glCompileShader,
      Vc: _emscripten_glCompressedTexImage2D,
      Uc: _emscripten_glCompressedTexSubImage2D,
      Tc: _emscripten_glCopyTexImage2D,
      Sc: _emscripten_glCopyTexSubImage2D,
      Rc: _emscripten_glCreateProgram,
      Qc: _emscripten_glCreateShader,
      Pc: _emscripten_glCullFace,
      Oc: _emscripten_glDeleteBuffers,
      Nc: _emscripten_glDeleteFramebuffers,
      Mc: _emscripten_glDeleteProgram,
      Lc: _emscripten_glDeleteQueriesEXT,
      Kc: _emscripten_glDeleteRenderbuffers,
      Jc: _emscripten_glDeleteShader,
      Ic: _emscripten_glDeleteTextures,
      Hc: _emscripten_glDeleteVertexArraysOES,
      Gc: _emscripten_glDepthFunc,
      Fc: _emscripten_glDepthMask,
      Ec: _emscripten_glDepthRangef,
      Dc: _emscripten_glDetachShader,
      Cc: _emscripten_glDisable,
      Bc: _emscripten_glDisableVertexAttribArray,
      Ac: _emscripten_glDrawArrays,
      zc: _emscripten_glDrawArraysInstancedANGLE,
      yc: _emscripten_glDrawBuffersWEBGL,
      xc: _emscripten_glDrawElements,
      wc: _emscripten_glDrawElementsInstancedANGLE,
      ...
      lc: _emscripten_glGenQueriesEXT,
      kc: _emscripten_glGenRenderbuffers,
      jc: _emscripten_glGenTextures,
      ic: _emscripten_glGenVertexArraysOES,
      ...
      $b: _emscripten_glGetFloatv,
      _b: _emscripten_glGetFramebufferAttachmentParameteriv,
      Zb: _emscripten_glGetIntegerv,
      Yb: _emscripten_glGetProgramInfoLog,
      Xb: _emscripten_glGetProgramiv,
      Wb: _emscripten_glGetQueryObjecti64vEXT,
      Vb: _emscripten_glGetQueryObjectivEXT,
      Ub: _emscripten_glGetQueryObjectui64vEXT,
      Tb: _emscripten_glGetQueryObjectuivEXT,
      Sb: _emscripten_glGetQueryivEXT,
      Rb: _emscripten_glGetRenderbufferParameteriv,
      Qb: _emscripten_glGetShaderInfoLog,
      Pb: _emscripten_glGetShaderPrecisionFormat,
      Ob: _emscripten_glGetShaderSource,
      Nb: _emscripten_glGetShaderiv,
      Mb: _emscripten_glGetString,
      Lb: _emscripten_glGetTexParameterfv,
      Kb: _emscripten_glGetTexParameteriv,
      Jb: _emscripten_glGetUniformLocation,
      Ib: _emscripten_glGetUniformfv,
      Hb: _emscripten_glGetUniformiv,
      Gb: _emscripten_glGetVertexAttribPointerv,
      Fb: _emscripten_glGetVertexAttribfv,
      Eb: _emscripten_glGetVertexAttribiv,
      Db: _emscripten_glHint,
      Cb: _emscripten_glIsBuffer,
      Bb: _emscripten_glIsEnabled,
      Ab: _emscripten_glIsFramebuffer,
      zb: _emscripten_glIsProgram,
      yb: _emscripten_glIsQueryEXT,
      xb: _emscripten_glIsRenderbuffer,
      wb: _emscripten_glIsShader,
      vb: _emscripten_glIsTexture,
      ub: _emscripten_glIsVertexArrayOES,
      tb: _emscripten_glLineWidth,
      sb: _emscripten_glLinkProgram,
      rb: _emscripten_glPixelStorei,
      qb: _emscripten_glPolygonModeWEBGL,
      pb: _emscripten_glPolygonOffset,
      ob: _emscripten_glPolygonOffsetClampEXT,
      nb: _emscripten_glQueryCounterEXT,
      mb: _emscripten_glReadPixels,
      lb: _emscripten_glReleaseShaderCompiler,
      kb: _emscripten_glRenderbufferStorage,
      jb: _emscripten_glSampleCoverage,
      ib: _emscripten_glScissor,
      hb: _emscripten_glShaderBinary,
      gb: _emscripten_glShaderSource,
      fb: _emscripten_glStencilFunc,
      eb: _emscripten_glStencilFuncSeparate,
      db: _emscripten_glStencilMask,
      cb: _emscripten_glStencilMaskSeparate,
      bb: _emscripten_glStencilOp,
      ab: _emscripten_glStencilOpSeparate,
      $a: _emscripten_glTexImage2D,
      _a: _emscripten_glTexParameterf,
      Za: _emscripten_glTexParameterfv,
      Ya: _emscripten_glTexParameteri,
      Xa: _emscripten_glTexParameteriv,
      Wa: _emscripten_glTexSubImage2D,
      Va: _emscripten_glUniform1f,
      Ua: _emscripten_glUniform1fv,
      Ta: _emscripten_glUniform1i,
      Sa: _emscripten_glUniform1iv,
      Ra: _emscripten_glUniform2f,
      Qa: _emscripten_glUniform2fv,
      Pa: _emscripten_glUniform2i,
      Oa: _emscripten_glUniform2iv,
      Na: _emscripten_glUniform3f,
      Ma: _emscripten_glUniform3fv,
      La: _emscripten_glUniform3i,
      Ka: _emscripten_glUniform3iv,
      Ja: _emscripten_glUniform4f,
      Ia: _emscripten_glUniform4fv,
      Ha: _emscripten_glUniform4i,
      Ga: _emscripten_glUniform4iv,
      Fa: _emscripten_glUniformMatrix2fv,
      Ea: _emscripten_glUniformMatrix3fv,
      Da: _emscripten_glUniformMatrix4fv,
      Ca: _emscripten_glUseProgram,
      Ba: _emscripten_glValidateProgram,
      Aa: _emscripten_glVertexAttrib1f,
      za: _emscripten_glVertexAttrib1fv,
      ya: _emscripten_glVertexAttrib2f,
      xa: _emscripten_glVertexAttrib2fv,
      wa: _emscripten_glVertexAttrib3f,
      va: _emscripten_glVertexAttrib3fv,
      ua: _emscripten_glVertexAttrib4f,
      ta: _emscripten_glVertexAttrib4fv,
      sa: _emscripten_glVertexAttribDivisorANGLE,
      ra: _emscripten_glVertexAttribPointer,
      qa: _emscripten_glViewport,
      ...
      I: _emscripten_set_keypress_callback_on_thread,
      ...
      na: _emscripten_set_window_title,
      l: _emscripten_sleep,
      pe: _environ_get,
      ...
      ne: _fd_sync,
      p: _fd_write,
      ma: initMessageSyncSleep,
      la: initTimeoutSyncSleep,
      ka: isNode,
      ja: isWorker,
      t: now,
      me: _proc_exit,
      ...
      ba: ws_client_error,
      aa: ws_client_log,
      $: ws_client_network_connected,
      h: ws_client_network_disconnected,
      _: ws_client_stdout,
      Z: ws_client_warn,
      Y: ws_init_runtime,
    }
    var wasmExports = await createWasm()
    var ___wasm_call_ctors = wasmExports['Fe']
    var _free = (Module['_free'] = wasmExports['He'])
    var _malloc = (Module['_malloc'] = wasmExports['Ie'])
    var _abort = (Module['_abort'] = wasmExports['Je'])
    var _fflush = wasmExports['Ke']
    var _getAndResetCycles = (Module['_getAndResetCycles'] = wasmExports['Le'])
    var _TriggerEventByName = (Module['_TriggerEventByName'] =
      wasmExports['Me'])
    var _get_changes_mtime_ms = (Module['_get_changes_mtime_ms'] =
      wasmExports['Ne'])
    var _zip_from_fs = (Module['_zip_from_fs'] = wasmExports['Oe'])
    var _zip_to_fs = (Module['_zip_to_fs'] = wasmExports['Pe'])
    var _zipfile_to_fs = (Module['_zipfile_to_fs'] = wasmExports['Qe'])
    var _libzip_destroy = (Module['_libzip_destroy'] = wasmExports['Re'])
    var _zipfile_add = (Module['_zipfile_add'] = wasmExports['Se'])
    var _networkConnect = (Module['_networkConnect'] = wasmExports['Te'])
    var _networkDisconnect = (Module['_networkDisconnect'] = wasmExports['Ue'])
    var _extractBundleToFs = (Module['_extractBundleToFs'] = wasmExports['Ve'])
    var _packFsToBundle = (Module['_packFsToBundle'] = wasmExports['We'])
    var _addKey = (Module['_addKey'] = wasmExports['Xe'])
    var _mouseMove = (Module['_mouseMove'] = wasmExports['Ye'])
    var _mouseButton = (Module['_mouseButton'] = wasmExports['Ze'])
    var _mouseSync = (Module['_mouseSync'] = wasmExports['_e'])
    var _exitRuntime = (Module['_exitRuntime'] = wasmExports['$e'])
    var _runRuntime = (Module['_runRuntime'] = wasmExports['af'])
    var _requestPause = (Module['_requestPause'] = wasmExports['bf'])
    var _requestResume = (Module['_requestResume'] = wasmExports['cf'])
    var _requestMute = (Module['_requestMute'] = wasmExports['df'])
    var _requestUnmute = (Module['_requestUnmute'] = wasmExports['ef'])
    var _requestExit = (Module['_requestExit'] = wasmExports['ff'])
    var _getConfigContent = (Module['_getConfigContent'] = wasmExports['gf'])
    var _main = (Module['_main'] = wasmExports['hf'])
    var _em_client_sockdrive_opened = (Module['_em_client_sockdrive_opened'] =
      wasmExports['jf'])
    var _em_client_sockdrive_new_range = (Module[
      '_em_client_sockdrive_new_range'
    ] = wasmExports['kf'])
    var _ws_client_net_recv = (Module['_ws_client_net_recv'] =
      wasmExports['lf'])
    var _fsDeleteFile = (Module['_fsDeleteFile'] = wasmExports['mf'])
    var ___funcs_on_exit = wasmExports['nf']
    var __emscripten_timeout = wasmExports['of']
    var ___trap = wasmExports['pf']
    var __emscripten_tempret_set = wasmExports['qf']
    var __emscripten_stack_restore = wasmExports['rf']
    var __emscripten_stack_alloc = wasmExports['sf']
    var _emscripten_stack_get_current = wasmExports['tf']
    var dynCall_i = (Module['dynCall_i'] = wasmExports['uf'])
    var dynCall_vi = (Module['dynCall_vi'] = wasmExports['vf'])
    var dynCall_ii = (Module['dynCall_ii'] = wasmExports['wf'])
    var dynCall_vii = (Module['dynCall_vii'] = wasmExports['xf'])
    var dynCall_iii = (Module['dynCall_iii'] = wasmExports['yf'])
    var dynCall_viii = (Module['dynCall_viii'] = wasmExports['zf'])
    var dynCall_viiii = (Module['dynCall_viiii'] = wasmExports['Af'])
    var dynCall_v = (Module['dynCall_v'] = wasmExports['Bf'])
    var dynCall_iiii = (Module['dynCall_iiii'] = wasmExports['Cf'])
    var dynCall_iiiiii = (Module['dynCall_iiiiii'] = wasmExports['Df'])
    var dynCall_iiiji = (Module['dynCall_iiiji'] = wasmExports['Ef'])
    var dynCall_jii = (Module['dynCall_jii'] = wasmExports['Ff'])
    var dynCall_iiiii = (Module['dynCall_iiiii'] = wasmExports['Gf'])
    var dynCall_viiiii = (Module['dynCall_viiiii'] = wasmExports['Hf'])
    var dynCall_viiiiiii = (Module['dynCall_viiiiiii'] = wasmExports['If'])
    var dynCall_iij = (Module['dynCall_iij'] = wasmExports['Jf'])
    var dynCall_ij = (Module['dynCall_ij'] = wasmExports['Kf'])
    var dynCall_jiij = (Module['dynCall_jiij'] = wasmExports['Lf'])
    var dynCall_ji = (Module['dynCall_ji'] = wasmExports['Mf'])
    var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = wasmExports['Nf'])
    var dynCall_iiji = (Module['dynCall_iiji'] = wasmExports['Of'])
    var dynCall_viiiiiiii = (Module['dynCall_viiiiiiii'] = wasmExports['Pf'])
    var dynCall_viiiiii = (Module['dynCall_viiiiii'] = wasmExports['Qf'])
    var dynCall_iiij = (Module['dynCall_iiij'] = wasmExports['Rf'])
    var dynCall_jiiiji = (Module['dynCall_jiiiji'] = wasmExports['Sf'])
    var dynCall_jiiji = (Module['dynCall_jiiji'] = wasmExports['Tf'])
    var dynCall_jiji = (Module['dynCall_jiji'] = wasmExports['Uf'])
    var dynCall_vffff = (Module['dynCall_vffff'] = wasmExports['Vf'])
    var dynCall_vf = (Module['dynCall_vf'] = wasmExports['Wf'])
    var dynCall_viiiiiiiii = (Module['dynCall_viiiiiiiii'] = wasmExports['Xf'])
    var dynCall_vff = (Module['dynCall_vff'] = wasmExports['Yf'])
    var dynCall_vfi = (Module['dynCall_vfi'] = wasmExports['Zf'])
    var dynCall_viif = (Module['dynCall_viif'] = wasmExports['_f'])
    var dynCall_vif = (Module['dynCall_vif'] = wasmExports['$f'])
    var dynCall_viff = (Module['dynCall_viff'] = wasmExports['ag'])
    var dynCall_vifff = (Module['dynCall_vifff'] = wasmExports['bg'])
    var dynCall_viffff = (Module['dynCall_viffff'] = wasmExports['cg'])
    var dynCall_vfff = (Module['dynCall_vfff'] = wasmExports['dg'])
    var dynCall_iidiiii = (Module['dynCall_iidiiii'] = wasmExports['eg'])
    var dynCall_viijii = (Module['dynCall_viijii'] = wasmExports['fg'])
    var dynCall_iiiiiiiii = (Module['dynCall_iiiiiiiii'] = wasmExports['gg'])
    var dynCall_iiiiij = (Module['dynCall_iiiiij'] = wasmExports['hg'])
    var dynCall_iiiiid = (Module['dynCall_iiiiid'] = wasmExports['ig'])
    var dynCall_iiiiijj = (Module['dynCall_iiiiijj'] = wasmExports['jg'])
    var dynCall_iiiiiiii = (Module['dynCall_iiiiiiii'] = wasmExports['kg'])
    var dynCall_iiiiiijj = (Module['dynCall_iiiiiijj'] = wasmExports['lg'])
    var _asyncify_start_unwind = wasmExports['mg']
    var _asyncify_stop_unwind = wasmExports['ng']
    var _asyncify_start_rewind = wasmExports['og']
    var _asyncify_stop_rewind = wasmExports['pg']
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = WDOSBOXX
    ...
    if (data.name === 'wc-install') {
      ...
      if (data.props.module !== undefined) {
        ...
        const instantiateWasm = (info, receiveInstance) => {
          info.env = info.env || {}
          return WebAssembly.instantiate(wasmModule, info).then((instance) =>
      ...
      WDOSBOXX(module).catch(console.error)
      return
    }
  }
}
