import type DosBundle from './dos/bundle/dos-bundle'
import type { AsyncifyStats, FsNode, TransportLayer } from './protocol/protocol'
...
export type InitFs = InitFsEntry | Array<InitFsEntry>
...
export interface CommandInterface {
  ...
  unmute: () => void
  exit: () => Promise<void>
  simulateKeyPress: (...keyCodes: Array<number>) => void
  ...
  persist: (
    onlyChanges?: boolean,
  ) => Promise<Uint8Array | PersistedSockdrives | null>
