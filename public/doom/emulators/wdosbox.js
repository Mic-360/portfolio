var WDOSBOX = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var wasmImports = {
      ...
      t: ws_client_error,
      s: ws_client_log,
      r: ws_client_network_connected,
      c: ws_client_network_disconnected,
      q: ws_client_stdout,
      p: ws_client_warn,
      o: ws_init_runtime,
    }
    ...
    var _abort = (Module['_abort'] = wasmExports['ra'])
    var _free = (Module['_free'] = wasmExports['ta'])
    var _malloc = (Module['_malloc'] = wasmExports['ua'])
    var _getAndResetCycles = (Module['_getAndResetCycles'] = wasmExports['va'])
    var _get_changes_mtime_ms = (Module['_get_changes_mtime_ms'] =
      wasmExports['wa'])
    var _zip_from_fs = (Module['_zip_from_fs'] = wasmExports['xa'])
    var _zip_to_fs = (Module['_zip_to_fs'] = wasmExports['ya'])
    var _zipfile_to_fs = (Module['_zipfile_to_fs'] = wasmExports['za'])
    var _libzip_destroy = (Module['_libzip_destroy'] = wasmExports['Aa'])
    var _zipfile_add = (Module['_zipfile_add'] = wasmExports['Ba'])
    var _networkConnect = (Module['_networkConnect'] = wasmExports['Ca'])
    var _networkDisconnect = (Module['_networkDisconnect'] = wasmExports['Da'])
    var _extractBundleToFs = (Module['_extractBundleToFs'] = wasmExports['Ea'])
    var _packFsToBundle = (Module['_packFsToBundle'] = wasmExports['Fa'])
    var _addKey = (Module['_addKey'] = wasmExports['Ga'])
    var _mouseMove = (Module['_mouseMove'] = wasmExports['Ha'])
    var _mouseButton = (Module['_mouseButton'] = wasmExports['Ia'])
    var _mouseSync = (Module['_mouseSync'] = wasmExports['Ja'])
    var _exitRuntime = (Module['_exitRuntime'] = wasmExports['Ka'])
    var _runRuntime = (Module['_runRuntime'] = wasmExports['La'])
    var _requestPause = (Module['_requestPause'] = wasmExports['Ma'])
    var _requestResume = (Module['_requestResume'] = wasmExports['Na'])
    var _requestMute = (Module['_requestMute'] = wasmExports['Oa'])
    var _requestUnmute = (Module['_requestUnmute'] = wasmExports['Pa'])
    var _requestExit = (Module['_requestExit'] = wasmExports['Qa'])
    var _getConfigContent = (Module['_getConfigContent'] = wasmExports['Ra'])
    var _main = (Module['_main'] = wasmExports['Sa'])
    ...
    var _ws_client_net_recv = (Module['_ws_client_net_recv'] =
      wasmExports['Va'])
    var _fsDeleteFile = (Module['_fsDeleteFile'] = wasmExports['Wa'])
    var _dumpMemory = (Module['_dumpMemory'] = wasmExports['Xa'])
    var _rescanFilesystem = (Module['_rescanFilesystem'] = wasmExports['Ya'])
    var _pauseExecution = (Module['_pauseExecution'] = wasmExports['Za'])
    var ___funcs_on_exit = wasmExports['_a']
    var _fflush = wasmExports['$a']
    var __emscripten_timeout = wasmExports['ab']
    var __emscripten_tempret_set = wasmExports['bb']
    var __emscripten_stack_alloc = wasmExports['cb']
    var dynCall_vi = (Module['dynCall_vi'] = wasmExports['db'])
    var _asyncify_start_unwind = wasmExports['eb']
    var _asyncify_stop_unwind = wasmExports['fb']
    var _asyncify_start_rewind = wasmExports['gb']
    var _asyncify_stop_rewind = wasmExports['hb']
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = WDOSBOX
...
if (worker) {
  onmessage = (e) => {
    ...
    if (data.name === 'wc-install') {
      ...
      WDOSBOX(module).catch(console.error)
      return
    }
  }
}
