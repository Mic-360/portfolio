...
The problem isn't shortening. The problem is that every major shortener is in the business of _analytics_, which is a polite word for surveillance. You don't get a short link — you get a tracking pixel with a redirect stapled to it. Your clicks are a product being sold before you've finished clicking.
