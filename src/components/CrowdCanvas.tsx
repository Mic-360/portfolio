...
const CrowdCanvas = ({ src, rows = 15, cols = 7 }: CrowdCanvasProps) => {
  ...
  }, [src, rows, cols, isMobile])

  return (
    <div className="pointer-events-none relative -mt-50 md:-mt-30 z-0 h-[400px] w-full overflow-hidden opacity-30 dark:opacity-20 mask-[linear-gradient(to_top,black,transparent)]">
